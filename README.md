...
<br>
A programming language that compiles simple operations to x86-64 assembly. Component uses postfix notation, is written in Rust, and is intended to be used for math computation.
<br>
<br>
